...
const description = "This is a Partybear.io Project";
const baseUri = "ipfs://https://ipfs.io/ipfs/bafybeics5pmlgccukaoym2kgvmvyygiyudwskpsbuce75ulcfokmropjbu"; // This will be replaced automatically
...
const BASE_URI = "https://ipfs.io/ipfs/bafybeics5pmlgccukaoym2kgvmvyygiyudwskpsbuce75ulcfokmropjbu"; // only update if you want to manually set the base uri
const PREREVEAL_TOKEN_URI = null; // only update if you want to manually set the prereveal token uri
const PRESALE_WHITELISTED_ADDRESSES = []; // only update if you want to manually set the whitelisted addresses

// ** OPTIONAL **
let CONTRACT_ADDRESS = "YOUR CONTRACT ADDRESS"; // If you want to manually include it1
